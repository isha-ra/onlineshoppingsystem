      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">All Prodcuts</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
$query ="SELECT * FROM product ORDER BY id DESC limit 0 ,8";
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      Are you sure you wanna delete this product?<br/>
     <p>Product Title: <?php echo $row['product_name']; ?></p>
      </div>
      <div class="modal-footer">
        <a class="btn btn-danger"   href="admin_productdelete.php?id= <?php echo $row["id"]; ?>"><i class="fa fa-trash"></i></a>
 ...
 <?php           
            ...
            <div class="col-sm-9 pull-right">
                ...
                include'dbconnection.php';
                    ...
                    {
                ?>
                        <a href="admin_productpageview.php?page=<?php echo $b;?>">
